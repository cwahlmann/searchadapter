...
Eine Implementierung ist mehr oder weniger trivial.

Die Zuordnung von Input- zu Output-Seite ist 1:1, es muss lediglich ein Cache (Output-Seite -> Scroll-Id) statt
(Output-Seite -> Input-Seite) verwendet werden.
